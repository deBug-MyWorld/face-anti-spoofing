...
class Fasnet:
    ...
    def __init__(self):
        ...
        first_model_weight_file = 'spoofing/2.7_80x80_MiniFASNetV2.pth'
        second_model_weight_file = 'spoofing/4_0_0_80x80_MiniFASNetV1SE.pth'
        # guarantees Fasnet imported and torch installed
        from spoofing import FasNetBackbone
